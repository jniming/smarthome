...
public class AlarmDeviceListAdpter extends BaseAdapter {
	private Context context;
	private List<Device> list;

	public AlarmDeviceListAdpter(List<Device> list, Context context) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(
					R.layout.alarm_device_list_item, null);
		...
		viewholder.setimg.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(context, BoxPowerValueActivity.class);
